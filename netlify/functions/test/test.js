...
const handler = async (event, context) => {
    ...
    switch (event.httpMethod) {
        case 'GET':
            ...
            return {
                ...
                body: 'too many segments in GET request, must be either' + 
                    ' /.netlify/functions/fauna-crud or' +
                    ' /.netlify/functions/fauna-crud/123456',
            }
        ...
        case 'PUT':
            ...
            return {
                statusCode: 500,
                body: 'invalid segments in POST request, must be ' +
                    '/.netlify/functions/fauna-crud/123456',
            }
        ...
        case 'DELETE':
            ...
            return {
                    statusCode: 500,
                    body: 'invalid segments in DELETE request, must be' +
                        ' /.netlify/functions/fauna-crud/123456',
                }
        default:
            return {
                statusCode: 500,
                body: 'unrecognized HTTP Method, must be one of ' +
                    'GET/POST/PUT/DELETE',
            }
    }
}
